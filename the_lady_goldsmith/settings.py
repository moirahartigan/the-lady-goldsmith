"""
Django settings for the_lady_goldsmith project.
...
ROOT_URLCONF = 'the_lady_goldsmith.urls'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'moirahartigan@gmail.com'
else:
...
if 'USE_AWS' in os.environ:
    # Cache control - tells browser to cache files for repeat visitors
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'ecommerce-pp5'
...
DEFAULT_FROM_EMAIL = 'theladygoldsmith@example.com'
